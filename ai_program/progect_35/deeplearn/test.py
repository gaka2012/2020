...
net = network.Network([784, 30, 10]) #输入的数据是784个,隐藏层有30个神经元，输出层有10个。
net.SGD(training_data, 30, 10, 3.0, test_data=test_data) #迭代次数；小批量数据的大小；学习速率。
